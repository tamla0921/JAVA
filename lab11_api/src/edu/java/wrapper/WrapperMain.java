...
// 자바의 기본 타입: boolean, byte, short, int, long, char, float, double. (소문자!!, 클래스의 이름만 대문자임..)
...
public class WrapperMain {
    ...
    public static void main(String[] args) {
        // Integer 타입의 객체 생성
        Integer number1 = Integer.valueOf(100); // int -- > Integer. (wrapper 클래스)
        System.out.println(number1);
        Integer number2 = Integer.valueOf("100"); // Strint -- > Integer.
        System.out.println(number2);
        
        
        // 기본 타입형 선언에서는 메서드를 사용할 수 없으나, 클래스를 사용한다면 메서드를 사용할 수 있다.
        
        int x = Integer.parseInt("123"); // String -- > int. (기본 타입)
        System.out.println(x); // --> x. 기본 타입은 메서드 사용 불가!
        
        
        // auto-boxing, auto-unboxing
        
        Integer number3 = 1; // auto-boxing: int 타입의 값을 Integer 타입의 객체로 자동 변환.
        System.out.println(number3.getClass());
        
        Object o = 1;
        System.out.println(o.getClass());
        
        int add = number1 + number2; // auto-unboxing: Integer 타입 객체를 int 타입으로 자동 변환.
        // 더하기 연산은... 객체 타입에서만 가능하나, Object + Object는 String 말고는 생소. Integer를 int로 바꿔줌. 그리고 int 타입에 값을 저장.
        System.out.println(add);
        
        // float, double 타입은 소수점 이하 오차가 생길 수 있음.
        
        double d1 = 1.1; // 0.11 * 10^1
        double d2 = 0.9; // 0.9 * 10^0
        ...
        // System.out.println(big1 - big2); // - 불가.. 객체에서는 안 되는 것이 다반사.
