...
import edu.java.modifier01.AccessTest; // 같은 패키지가 아닌, 다른 패키지의 클래스인 경우에는 import 입력.
...
// java.lang 패키지에 포함된 클래슫르은 import 문장 없이 클래스 이름을 사용할 수 있음.
...
public class ModifierMain02 {
    ...
    public static void main(String[] args) {
        ...
        // test.c = 100; // The field AccessTest.c is not visible.
